...
bool spStrippify::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return nif->checkVersion( 0x0a000000, 0 ) && nif->isNiBlock( index, "NiTriShape" );
}

QModelIndex spStrippify::cast( NifModel * nif, const QModelIndex & index )
{
...
bool spStrippifyAll::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return nif->checkVersion( 0x0a000000, 0 ) && !index.isValid();
}

QModelIndex spStrippifyAll::cast( NifModel * nif, const QModelIndex & )
{
...
bool spTriangulate::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return nif->isNiBlock( index, "NiTriStrips" );
}

QModelIndex spTriangulate::cast( NifModel * nif, const QModelIndex & index )
{
	QPersistentModelIndex idx = index;
...
bool spTriangulateAll::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return !index.isValid();
}

QModelIndex spTriangulateAll::cast( NifModel * nif, const QModelIndex & )
{
...
QModelIndex spStichStrips::getStripsData( const NifModel * nif, const QModelIndex & index )
{
...
bool spStichStrips::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	QModelIndex iData = getStripsData( nif, index );
	return iData.isValid() && nif->get<int>( iData, "Num Strips" ) > 1;
}

QModelIndex spStichStrips::cast( NifModel * nif, const QModelIndex & index )
{
	QModelIndex iData = getStripsData( nif, index );
...
bool spUnstichStrips::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	QModelIndex iData = spStichStrips::getStripsData( nif, index );
	return iData.isValid() && nif->get<int>( iData, "Num Strips" ) == 1;
}

QModelIndex spUnstichStrips::cast( NifModel * nif, const QModelIndex & index )
{
	QModelIndex iData = spStichStrips::getStripsData( nif, index );
	QModelIndex iLength = nif->getIndex( iData, "Strip Lengths" );
	QModelIndex iPoints = nif->getIndex( iData, "Points" );
