...
bool spMorphFrameSave::isApplicable( const NifModel * nif, const QModelIndex & index )
{
...
QModelIndex spMorphFrameSave::cast( NifModel * nif, const QModelIndex & index )
{
...
QModelIndex spMorphFrameSave::getMeshData( const NifModel * nif, const QModelIndex & iMorpher )
{
...
QModelIndex spMorphFrameSave::getMorphData( const NifModel * nif, const QModelIndex & iMorpher )
{
	return nif->getBlock( nif->getLink( iMorpher, "Data" ), "NiMorphData" );
}

QModelIndex spMorphFrameSave::getFrameArray( const NifModel * nif, const QModelIndex & iMorpher )
{
	return nif->getIndex( getMorphData( nif, iMorpher ), "Morphs" );
}

QStringList spMorphFrameSave::listFrames( const NifModel * nif, const QModelIndex & iMorpher )
{
