...
bool spCreateCVS::isApplicable( const NifModel * nif, const QModelIndex & index )
{
...
QModelIndex spCreateCVS::cast( NifModel * nif, const QModelIndex & index )
{
	QModelIndex iData = nif->getBlock( nif->getLink( index, "Data" ) );
...
bool spConstraintHelper::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return nif &&
...
QModelIndex spConstraintHelper::cast( NifModel * nif, const QModelIndex & index )
{
...
Transform spConstraintHelper::bodyTrans( const NifModel * nif, const QModelIndex & index )
{
	Transform t;
...
bool spStiffSpringHelper::isApplicable( const NifModel * nif, const QModelIndex & idx )
{
	return nif && nif->isNiBlock( nif->getBlock( idx ), "bhkStiffSpringConstraint" );
}

QModelIndex spStiffSpringHelper::cast( NifModel * nif, const QModelIndex & idx )
{
...
bool spPackHavokStrips::isApplicable( const NifModel * nif, const QModelIndex & idx )
{
	return nif->isNiBlock( idx, "bhkNiTriStripsShape" );
}

QModelIndex spPackHavokStrips::cast( NifModel * nif, const QModelIndex & iBlock )
{
