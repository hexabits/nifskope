...
QModelIndex spAttachKf::cast( NifModel * nif, const QModelIndex & index )
{
	if ( !nif )
	return index;
...
QModelIndex spAttachKf::findChildNode( const NifModel * nif, const QModelIndex & parent, const QString & name )
{
...
QModelIndex spAttachKf::findRootTarget( const NifModel * nif, const QString & name )
{
...
QModelIndex spAttachKf::findController( const NifModel * nif, const QModelIndex & node, const QString & ctrltype )
{
...
QModelIndex spAttachKf::attachController( NifModel * nif, const QPersistentModelIndex & iNode, const QString & ctrltype, bool fast )
{
...
void spAttachKf::setLinkArray( NifModel * nif, const QModelIndex & iParent, const QString & array, const QList<QPersistentModelIndex> & iBlocks )
{
...
void spAttachKf::setNameLinkArray( NifModel * nif, const QModelIndex & iParent, const QString & array, const QList<QPersistentModelIndex> & iBlocks )
{
	QModelIndex iNum = nif->getIndex( iParent, QString( "Num %1" ).arg( array ) );
	QModelIndex iArray = nif->getIndex( iParent, array );
...
bool spConvertQuatsToEulers::isApplicable( const NifModel * nif, const QModelIndex & index )
{
...
/*
QModelIndex spConvertQuatsToEulers::cast( NifModel * nif, const QModelIndex & index )
{
...
bool spFixAVObjectPalette::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	QModelIndex iBlock = nif->getBlock( index, "NiDefaultAVObjectPalette" );
	return iBlock.isValid();
}

QModelIndex spFixAVObjectPalette::cast( NifModel * nif, const QModelIndex & index )
{
