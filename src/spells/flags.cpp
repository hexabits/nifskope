...
QModelIndex spEditFlags::getFlagIndex( const NifModel * nif, const QModelIndex & index ) const
{
...
FlagType spEditFlags::queryType( const NifModel * nif, const QModelIndex & index ) const
{
...
bool spEditFlags::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return queryType( nif, getFlagIndex( nif, index ) ) != None;
}

QModelIndex spEditFlags::cast( NifModel * nif, const QModelIndex & index )
{
...
void spEditFlags::alphaFlags( NifModel * nif, const QModelIndex & index )
{
...
//! Set flags on a Node
void spEditFlags::nodeFlags( NifModel * nif, const QModelIndex & index )
{
	quint16 flags = nif->get<int>( index );
...
void spEditFlags::controllerFlags( NifModel * nif, const QModelIndex & index )
{
	quint16 flags = nif->get<int>( index );
...
void spEditFlags::bodyFlags( NifModel * nif, const QModelIndex & index )
{
	quint16 flags = nif->get<int>( index );
...
//! Set flags on a Mesh
void spEditFlags::shapeFlags( NifModel * nif, const QModelIndex & index )
{
	quint16 flags = nif->get<int>( index );
...
void spEditFlags::zbufferFlags( NifModel * nif, const QModelIndex & index )
{
	quint16 flags = nif->get<int>( index );
...
//! Set BSX flags
void spEditFlags::bsxFlags( NifModel * nif, const QModelIndex & index )
{
...
void spEditFlags::niavFlags( NifModel * nif, const QModelIndex & index )
{
	quint32 flags = nif->get<int>( index );
...
void spEditFlags::billboardFlags( NifModel * nif, const QModelIndex & index )
{
	quint16 flags = nif->get<int>( index );
...
void spEditFlags::stencilFlags( NifModel * nif, const QModelIndex & index )
{
	quint16 flags = nif->get<int>( index );
...
void spEditFlags::vertexColorFlags( NifModel * nif, const QModelIndex & index )
{
	quint16 flags = nif->get<int>( index );
...
void spEditFlags::matColControllerFlags( NifModel * nif, const QModelIndex & index )
{
	quint16 flags = nif->get<int>( index );
...
void spEditFlags::texDescFlags( NifModel * nif, const QModelIndex & index )
{
	quint16 flags = nif->get<int>( index );
...
*/
QCheckBox * spEditFlags::dlgCheck( QVBoxLayout * vbox, const QString & name, QCheckBox * chk )
{
...
*/
QComboBox * spEditFlags::dlgCombo( QVBoxLayout * vbox, const QString & name, QStringList items, QCheckBox * chk)
{
...
*/
QSpinBox * spEditFlags::dlgSpin( QVBoxLayout * vbox, const QString & name, int min, int max, QCheckBox * chk)
{
	vbox->addWidget( new QLabel( name ) );
...
bool spEditVertexDesc::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return nif->inherits( index.parent(), "BSTriShape" ) && nif->itemName( index ) == "Vertex Desc";
}

QModelIndex spEditVertexDesc::cast( NifModel * nif, const QModelIndex & index )
{
