...
bool spCombiProps::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return nif && !index.isValid();
}

QModelIndex spCombiProps::cast( NifModel * nif, const QModelIndex & )
{
	int numRemoved = 0;
...
bool spUniqueProps::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return nif && !index.isValid();
}

QModelIndex spUniqueProps::cast( NifModel * nif, const QModelIndex & index )
{
...
bool spRemoveBogusNodes::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return nif && !index.isValid();
}

QModelIndex spRemoveBogusNodes::cast( NifModel * nif, const QModelIndex & index )
{
	Q_UNUSED( index );
	bool removed;
	int cnt = 0;
...
bool spCombiTris::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return nif && nif->isNiBlock( index, "NiNode" );
}

QModelIndex spCombiTris::cast( NifModel * nif, const QModelIndex & index )
{
...
bool spCombiTris::matches( const NifModel * nif, const QModelIndex & iTriA, const QModelIndex & iTriB )
{
	if ( iTriA == iTriB
...
bool spCombiTris::dataMatches( const NifModel * nif, const QModelIndex & iDataA, const QModelIndex & iDataB )
{
	if ( iDataA == iDataB )
		return true;
...
void spCombiTris::combine( NifModel * nif, const QModelIndex & iTriA, const QModelIndex & iTriB )
{
...
bool spRemoveUnusedStrings::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return nif && !index.isValid();
}

QModelIndex spRemoveUnusedStrings::cast( NifModel * nif, const QModelIndex & )
{
