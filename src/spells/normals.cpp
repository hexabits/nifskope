...
QModelIndex spFaceNormals::getShapeData( const NifModel * nif, const QModelIndex & index )
{
...
bool spFaceNormals::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return getShapeData( nif, index ).isValid();
}

QModelIndex spFaceNormals::cast( NifModel * nif, const QModelIndex & index )
{
...
bool spFlipNormals::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	QModelIndex iData = spFaceNormals::getShapeData( nif, index );
	return ( iData.isValid() && nif->get<bool>( iData, "Has Normals" ) );
}

QModelIndex spFlipNormals::cast( NifModel * nif, const QModelIndex & index )
{
	QModelIndex iData = spFaceNormals::getShapeData( nif, index );
...
bool spSmoothNormals::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return spFaceNormals::getShapeData( nif, index ).isValid();
}

QModelIndex spSmoothNormals::cast( NifModel * nif, const QModelIndex & index )
{
	QModelIndex iData = spFaceNormals::getShapeData( nif, index );
...
bool spNormalize::isApplicable( const NifModel * nif, const QModelIndex & index )
{
	return ( nif->getValue( index ).type() == NifValue::tVector3 )
		   || ( nif->isArray( index ) && nif->getValue( index.child( 0, 0 ) ).type() == NifValue::tVector3 );
}

QModelIndex spNormalize::cast( NifModel * nif, const QModelIndex & index )
{
